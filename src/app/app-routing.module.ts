...
const routes: Routes = [
  ...
  {path: "teacher/list/sv/pb", component : TeacherListSvPbComponent, canActivate:[AuthorizeGuard]},
  {path: "councli/list/teacher", component : CouncliListTeacherComponent, canActivate:[AuthorizeGuard]},
